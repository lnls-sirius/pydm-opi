...
from src.mks937b.ioc import worker, kill_ioc, get_process,  IOC_MAN_UI, IOC_FILENAME
...
class IocMan(Display):
    ...
    def getDir(self):
        global IOC_FILENAME
        string = QFileDialog.getOpenFileName(
            self, "Select the iocBoot file.", IOC_FILENAME, "cmd (*.cmd)")
        # print(string)
        try:
